...
export default function Front() {
  ...
  return (
    <Container disableGutters>
      ...
      <div id='newsletter' style={{ display: 'flex', justifyContent: 'space-between', margin: '20px 40px' }}>
        <div id='newsletter2' style={{ flex: 1, marginRight: '20px' }}>
          <Typography variant="body1">Subscribe to H.E.R. news</Typography>
          <Typography variant="body2">Receive new entries directly to your inbox</Typography>
        </div>
        <div style={{ flex: 1, marginRight: '20px' }}>
          
        </div>
        <div id='newsletter2' >
          <Button id="btn-color-wallet2" component={RouterLink} to="/formulario" variant="contained" color="primary">
            Subscribe
          </Button>
        </div>
      </div>
      {/* seccion entries */}
      <div  id='entries' style={{ display: 'flex', justifyContent: 'space-between', margin: '20px 40px' }}>
        <div style={{ flex: 1, marginRight: '20px',textAlign: 'center' }}>
          <Typography  style={{ margin: '4px' }} variant="body1">Entries</Typography> 
        </div>
       </div>           
       {/* imagen1 */}
