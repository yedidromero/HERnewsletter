    ...
    <AppBar position="static" elevation={0} sx={{ backgroundColor: 'transparent', width: '100%' }}>
      <Toolbar sx={{ justifyContent: 'space-between' }}>
        ...
        {isConnected ? (
          ...
          <Button variant="contained" onClick={() => setShowConnectPopup(true)}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={4}>
          ...
          <Typography variant="h2" color="secondary" sx={{ mt: 2 }}>
            La casa de las HER news
          </Typography>
          <Typography variant="body1" sx={{ mt: 2 , fontSize: '1.6rem',fontWeight: '500'}}>
            La intersección perfecta entre tendencias, inspiración, y
            oportunidades de monetización de la comunidad de H.E.R. DAO Latam
          </Typography>
          {/* Botones */}
          <Box mt={2} display="flex" justifyContent="space-between" width="76%">
            <Button variant="contained" component={RouterLink} to="Front" sx={{ bgcolor: '#add8e6', borderRadius: '4px',color: 'white' }}>
              Get Started
            </Button>
            <Button variant="contained" component={RouterLink} to="/pagina-generica" sx={{ bgcolor: '#add8e6', borderRadius: '4px',color: 'white' }}>
              Learn Mores
            </Button>
          </Box>
        </Grid>
